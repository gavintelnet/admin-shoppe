...
import { changeStatusDeposit } from "../apis";
...
import { changeStatusDraw } from "../../Withdraw/apis";
...
const ModalAction = (props: any) => {
  ...
  const handleConfirm = async () => {
    try {
      ...
      console.log(payload);
      const rp = await changeStatusDeposit(dataDetail._id, payload);
      if (rp.status) {
        dispatch(
          showNotification({
            message: rp.message,
    ...
    >
      ...
      <div style={cardStyle}>
        ...
        <div className="info-row">
          ...
          <span className="info-value">Nạp tiền</span>
        </div>
        <div className="info-row">
